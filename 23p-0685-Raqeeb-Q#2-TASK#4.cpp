...
class LinkedList
{
      ...
      void insertion(int value, int position)
    {
       ...
       //Insertion between head and end
        ...
        //Function to add the odd number from the original list to new list
        ...
        //Function to add the even number from the original list to new list
