...
class Double_Linked_list
{
    ...
    void Update_price(int ID, int price)
    {
       ...
       //If the if condition inside the loop will never become true and the loops complete its iteration then it means invalid ID is provided
    ...
    void find_product(int id)
    {
       ...
       { if(curr->ID==id)
        ...
        //If the loop completes it iteration then it means invalid ID is provided
...
int main(void)
{
    ...
    int quantity;
    int price;
    //Infinite loop to control the exit by the user
    while(1)
    {
